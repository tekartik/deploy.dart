...
void defineTests() {
  group('copy_file', () {
    test('copy_file_if_newer', () {
      clearTestOutPath();
      final path1 = outDataFilenamePath(simpleFileName);
      final path2 = outDataFilenamePath(simpleFileName2);
    ...
    test('copy_files_if_newer', () {
      clearTestOutPath();
      final sub1 = outDataFilenamePath('sub1');
      ...
      final subSub1 = outDataFilenamePath(join('sub1', 'sub1'));
      final file3 = join(subSub1, simpleFileName);
      writeStringContentSync(file3, simpleContent + '3');

      final sub2 = outDataFilenamePath('sub2');
